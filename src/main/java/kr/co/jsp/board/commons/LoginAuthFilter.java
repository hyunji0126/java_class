...
@WebFilter( filterName = "loginAuth",
			urlPatterns = {"/writer.board","/modify.board","/delete.board","/myPage.user"},
			servletNames = {"basic"})
...
//		보통 초기화 시 생성했던 자원들을 종료하는 기능에 사용합니다.
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		/*
		 ...
		 - request객체와 response객체를 넘겨주기 떄문에 이를 가지고 요청과 응답을 조작할 수 있습니다.
		 - 그리고 FilterChain을 통해 조작 이후 요청을 원래 목적지인 서블릿으로 전달할 수 있습니다.
		 */
		System.out.println("doFilter 메서드 발동!");
		
//		평소에 사용하던 타입은 HttpServletRequest입니다.
...
//		이 떄 객체가 생성되면서 최초 한 번 호출되는 메서드입니다.
